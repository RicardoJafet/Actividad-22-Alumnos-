/* Autor: Ricardo Jafet Granados Chable 05/05/2022
...
//Guardar los datos del arreglo de estructuras en un archivo binario
void guardar(struct alumno x[]){
	FILE *f;
...
//Leer el archivo binario y cargarlo al arreglo de estructura
void cargar(struct alumno x[]){
	FILE*f;
	struct alumno a;
